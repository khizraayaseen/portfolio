        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
          ...
          >
            ...
            <p className="text-lg md:text-xl text-gray-600 dark:text-gray-400 mb-8 max-w-2xl mx-auto lg:mx-0">
              Motivated and detail-oriented Computer Science Senior student with internship experience in development
              and data science. Committed to continuous growth and contributing to impactful projects in AI, Machine
              Learning, and Web Development.
            </p>
            <div className="flex justify-center lg:justify-start space-x-4 mb-8">
              <a
                href="https://github.com/khizraayaseen"
                target="_blank"
              ...
              <a
                href="https://linkedin.com/in/khizraayaseen"
                target="_blank"
                rel="noopener noreferrer"
                className="p-3 rounded-full bg-white/80 hover:bg-white dark:bg-gray-800/80 dark:hover:bg-gray-800 transition-colors duration-300 shadow-lg hover:shadow-xl"
              ...
              <a
                href="mailto:khizrayaseen05@gmail.com"
                className="p-3 rounded-full bg-white/80 hover:bg-white dark:bg-gray-800/80 dark:hover:bg-gray-800 transition-colors duration-300 shadow-lg hover:shadow-xl"
          ...
          >
            <div className="relative w-72 h-72 md:w-96 md:h-96 mx-auto">
              ...
              <div className="relative rounded-2xl overflow-hidden shadow-2xl">
                <Image
                  src="/KhizraYaseen-Pic.jpg?height=384&width=384"
                  alt="Khizra Yaseen"
                  width={384}
                  height={384}
