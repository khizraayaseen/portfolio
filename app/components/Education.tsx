...
export default function Education() {
  const education = [
    {
      ...
      achievements: [
        "Specializing in AI, Machine Learning, Deep Learning, Data Science, NLP, Computer Vision, and Web programming",
        "Engaged in various academic projects showcasing practical application of learned concepts",
  ...
  const courses = [
    ...
    "Become an AI Engineer (LinkedIn)",
  ...
  return (
    ...
    >
      <div className="container mx-auto px-6 relative z-10">
        <AnimatedSectionHeader title="Education & Courses" />
        <div className="max-w-3xl mx-auto">
          ...
          >
            <h3 className="text-2xl font-semibold mb-4 dark:text-white">Additional Courses</h3>
